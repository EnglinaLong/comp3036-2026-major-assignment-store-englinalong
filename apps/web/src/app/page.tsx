...
export default async function Page() {
  ...
  const categoryItems = categories(storefrontProducts);
  const collectionItems = await tags(storefrontProducts);
  const historyItems = history(storefrontProducts);
